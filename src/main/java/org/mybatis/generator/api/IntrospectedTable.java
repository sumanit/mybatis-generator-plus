...
public abstract class IntrospectedTable {
    ...
    protected enum InternalAttribute {
        ...
        ATTR_BASE_RECORD_DTO_TYPE,
        ATTR_BASE_RECORD_DTO_BASE_TYPE,
    ...
    protected void calculateModelAttributes() {
        ...
        sb.setLength(0);
        sb.append(pakkage.replace("model","dto"));
        sb.append('.');
        sb.append(fullyQualifiedTable.getDomainObjectName());
        sb.append("DTO");
        ...
        sb.setLength(0);
        sb.append(pakkage.replace("model","dto.base"));
        sb.append('.');
        sb.append(fullyQualifiedTable.getDomainObjectName());
        sb.append("DTOBase");
        setBaseRecordDTOBaseType(sb.toString());
    }
    ...
    protected List<IntrospectedColumn>  foreignKeyColumns = new ArrayList<>();//add by suman
    ...
    public void setBaseRecordDTOBaseType(String baseRecordDTOBaseType) {
        internalAttributes.put(InternalAttribute.ATTR_BASE_RECORD_DTO_BASE_TYPE, baseRecordDTOBaseType);
    }
    ...
    public String getBaseRecordDTOBaseType() {
        return internalAttributes.get(InternalAttribute.ATTR_BASE_RECORD_DTO_BASE_TYPE);
    }
