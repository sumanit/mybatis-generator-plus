...
public class FullyQualifiedJavaType implements
    ...
    public static final FullyQualifiedJavaType getGeneratedCriteriaInstance() {
        if (generatedCriteriaInstance == null) {
            generatedCriteriaInstance = new FullyQualifiedJavaType(
                    "BaseExample.GeneratedCriteria"); //$NON-NLS-1$
        }
    ...
    private static org.mybatis.generator.api.dom.java.FullyQualifiedJavaType columnContainerInstance = null;

    private static org.mybatis.generator.api.dom.java.FullyQualifiedJavaType stringBufferInstance = null;

    private static org.mybatis.generator.api.dom.java.FullyQualifiedJavaType columnContainerBaseInstance = null;

    public static final org.mybatis.generator.api.dom.java.FullyQualifiedJavaType getColumnContainerInstance() {
        if (columnContainerInstance == null) {
            columnContainerInstance = new org.mybatis.generator.api.dom.java.FullyQualifiedJavaType(
    ...
    public static final org.mybatis.generator.api.dom.java.FullyQualifiedJavaType getColumnContainerBaseInstance() {
        if (columnContainerBaseInstance == null) {
            columnContainerBaseInstance = new org.mybatis.generator.api.dom.java.FullyQualifiedJavaType(
                    "ColumnContainerBase"); //$NON-NLS-1$
        }

        return columnContainerBaseInstance;
    }
    public static final org.mybatis.generator.api.dom.java.FullyQualifiedJavaType getStringBufferInstance() {
        if (stringBufferInstance == null) {
            stringBufferInstance = new org.mybatis.generator.api.dom.java.FullyQualifiedJavaType("java.lang.StringBuffer"); //$NON-NLS-1$
        }
