...
public class JavaMapperGenerator extends AbstractJavaClientGenerator {
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        FullyQualifiedJavaType mapperInterface = new FullyQualifiedJavaType("com.github.sumanit.base.Mapper<"+introspectedTable.getBaseRecordType()+","+introspectedTable.getBaseRecordType()+"Example>");
        interfaze.addSuperInterface(mapperInterface);
        interfaze.addImportedType(mapperInterface);
